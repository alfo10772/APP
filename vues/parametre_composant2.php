...
<body>
	...
	<br>
		...
		//Cherche l'ID et le type du composant en fonction du nom, de la pi�ce et de la maison, dans la table capteur
		
		if($idtype == NULL) //Si le type est NULL c'est que le composant n'a pas �t� trouv� dans la table capteur, c'est donc un actionneur
		
		{
		    ...
		    //Cherche l'ID et le type du composant en fonction du nom, de la pi�ce et de la maison, dans la table actionneur
		}
		
		if($idtype==0)    //Si le type est 0 alors c'est un capteur donc on affiche le formulaire pour les param�tres des capteurs
		{
		?>
			<form action="../traitements/parametre_capteur.php" method="post"> <!-- D�but du formulaire de param�tres pour un capteur -->
				<div id="conteneur2">
		...
		elseif($idtype==1)    //Si le type est 1 alors c'est un actionneur donc on affiche le formulaire pour les param�tres des actionneurs
		{
		?>
